...
contract Token is Context, IERC20, Ownable {
    ...
    address public mainAddres = address(0xaA1C7b506133c9192Ec491966807bA6952b80334);
    address public marketAddress = address(0x239ca55796b4e33cE6063F8a8B21916980DA6008);
    address public fundAddress = address(0xb70F41f34819F6D39f566A4813909E7567B089Ad);
    address public liquidAddress = address(0xb70F41f34819F6D39f566A4813909E7567B089Ad);
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        if (balanceOf(burnAddress) < 2700000000 * 10 ** decimals() 
        ...
        _takeMarket(sender, tElseFee * 2 / _elseFee);   // 2%
